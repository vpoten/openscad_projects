...
module DisplayCubicCurve(M, umult=1, cps, steps=10, showNormals = false) 
{
	G = [
...
module DisplayHermiteCurveLine(cps, steps=10) 
{
	DisplayCubicCurve(cubic_hermite_M(), cps, steps=steps); 
}

module DisplayHermiteCurve(cps, steps=6) 
{
